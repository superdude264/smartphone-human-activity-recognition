...
output:
  html_document:
    df_print: paged
---
```{r GlobalOptions, echo=FALSE, message=FALSE, results='hide', purl=FALSE}
# Option to generate R script from this notebook via purl
...
# Write the code in the document to an R script
knitr::purl(knitr::current_input(),"run_analysis.R", documentation = 2, quiet = TRUE)
```
